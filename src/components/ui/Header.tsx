          ...
          <div className="relative">
            ...
            {showDropdown && (
              <motion.div
                ...
                className={`absolute ${ currentLang === "ar"?"left-0" : "right-0" } mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-purple-200/50 border border-purple-100/50 overflow-hidden z-50`}
              >
                <div className="p-2">
                  <button
